<%@ Page Title="" Language="C#" MasterPageFile="~/BackEnd.Master" AutoEventWireup="true" CodeBehind="ManagePassword.aspx.cs" Inherits="Shanghai.WebApp.Account.ManagePassword" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row container mainContainer changePasswordContainer" style="min-height: calc(100vh - 150px);">
    <div class="form-horizontal">
        <section id="passwordForm">
            <asp:PlaceHolder runat="server" ID="successMessage" Visible="false" ViewStateMode="Disabled">
                <div class="alert alert-success" style="margin-bottom: 0 !important;"><p class="text-success"><%: SuccessMessage %></p></div>
            </asp:PlaceHolder>
            <asp:PlaceHolder runat="server" ID="setPassword" Visible="false">
                ...
                <div class="form-horizontal changePasswordContent">
            ...
            <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                <div class="form-horizontal changePasswordContent">
                    ...
                    <div>
                        <p style="text-align: center;"><i>Note:<br /> Password must be at least 6 characters long and must include a number</i></p>
                    </div>
                    <div class="form-group">
